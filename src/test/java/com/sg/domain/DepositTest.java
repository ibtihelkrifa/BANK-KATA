...
public class DepositTest {
	...
	public void deposit_on_empty_account() {
		...
		statement.addStatementLine(new Transaction(Type.DEPOSIT, 1000, LocalDate.parse("19/01/2022", DateTimeFormatter.ofPattern("dd/MM/yyyy"))));
	...
	public void deposit_on_non_empty_account() {
		...
		Statement statement = new Statement();
		statement.addStatementLine(new Transaction(Type.DEPOSIT, 1000, LocalDate.parse("19/01/2022", DateTimeFormatter.ofPattern("dd/MM/yyyy"))));
		statement.addStatementLine(new Transaction(Type.DEPOSIT, 2000, LocalDate.parse("19/01/2022", DateTimeFormatter.ofPattern("dd/MM/yyyy"))));
	...
	public void deposit_should_add_one_statement_line() {
		...
		Transaction transaction = new Transaction(Type.DEPOSIT, 1000, LocalDate.parse("19/01/2022", DateTimeFormatter.ofPattern("dd/MM/yyyy")));
